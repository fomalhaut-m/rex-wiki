---
title: CLion 开发 STM32 环境搭建
weight: 10
---

# 手把手教你用 CLion 开发 STM32

> 来源：B 站视频 BV1pnjizYEAk（UP：keysking）
> 整理日期：2026-07-15
> 配套图片位于本目录下的 `assets/` 子目录
...
![STM32 工具链配置](assets/clion-01-toolchain.png)
...
![CMake 默认构建类型配置](assets/clion-02-cmake.png)
...
![为所有项目启用调试服务器](assets/clion-03-debug-server.png)
...
![调试器服务入口](assets/clion-04-debugger-services.png)
![ST-Link 调试服务配置](assets/clion-05-stlink-settings.png)
![ST-Link 调试服务添加完成](assets/clion-06-stlink-done.png)
